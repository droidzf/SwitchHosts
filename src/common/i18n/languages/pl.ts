...
export default {
  ...
  days: 'dni',
  delete: 'Usuń',
  domain_resolution: 'Rozwiązywanie domen',
  download: 'Pobierz',
  edit: 'Edytuj',
  export: 'Eksportuj',
  ...
  resolver_add: 'Dodaj Resolver',
  resolver_delete_confirm: 'Usunąć Resolver „{0}”?',
  resolver_empty: 'Brak konfiguracji Resolver.',
  resolver_name: 'Nazwa Resolver',
  resolver_name_invalid: 'Użyj tylko liter, cyfr, kropek, łączników i podkreśleń.',
  resolver_name_placeholder: 'Na przykład: internal.example',
  resolver_rename: 'Zmień nazwę Resolver',
  resolver_saved: 'Konfiguracja Resolver została zapisana.',
  rules: 'Reguły',
