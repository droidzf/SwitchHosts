...
const lang: LanguageDict = {
  ...
  reset_zoom: '重設縮放',
  resolver_add: '新增 Resolver',
  resolver_delete_confirm: '確定刪除 Resolver「{0}」嗎？',
  resolver_empty: '尚無 Resolver 設定',
  resolver_name: 'Resolver 名稱',
  resolver_name_invalid: '僅支援字母、數字、點、連字號和底線。',
  resolver_name_placeholder: '例如：internal.example',
  resolver_rename: '修改 Resolver 名稱',
  resolver_saved: 'Resolver 設定已儲存。',
  rules: '規則數',
  save_success: '儲存成功',
  search: '搜尋',
  select_all: '全選',
