...
export default {
  ...
  days: 'günler',
  delete: 'Sil',
  domain_resolution: 'Alan Adı Çözümleme',
  download: 'İndir',
  edit: 'Düzenle',
  export: 'Dışa aktar',
  ...
  resolver_add: 'Resolver Ekle',
  resolver_delete_confirm: '“{0}” Resolver silinsin mi?',
  resolver_empty: 'Henüz Resolver yapılandırması yok.',
  resolver_name: 'Resolver adı',
  resolver_name_invalid: 'Yalnızca harf, rakam, nokta, tire ve alt çizgi kullanın.',
  resolver_name_placeholder: 'Örneğin: internal.example',
  resolver_rename: 'Resolver Adını Değiştir',
  resolver_saved: 'Resolver yapılandırması kaydedildi.',
  rules: 'Kurallar',
