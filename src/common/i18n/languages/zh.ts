...
const lang: LanguageDict = {
  ...
  reset_zoom: '重置缩放',
  resolver_add: '添加 Resolver',
  resolver_delete_confirm: '确定删除 Resolver“{0}”吗？',
  resolver_empty: '暂无 Resolver 配置',
  resolver_name: 'Resolver 名称',
  resolver_name_invalid: '仅支持字母、数字、点、短横线和下划线。',
  resolver_name_placeholder: '例如：internal.example',
  resolver_rename: '修改 Resolver 名称',
  resolver_saved: 'Resolver 配置已保存。',
  rules: '规则数',
  save_success: '保存成功',
  search: '搜索',
  select_all: '全选',
