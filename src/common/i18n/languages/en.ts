...
export default {
  ...
  resolver_delete_confirm: 'Delete resolver “{0}”?',
  resolver_empty: 'No resolver configurations yet.',
  resolver_name: 'Resolver name',
  resolver_name_invalid: 'Use only letters, numbers, dots, hyphens, and underscores.',
  resolver_name_placeholder: 'For example: internal.example',
  resolver_rename: 'Rename Resolver',
  resolver_saved: 'Resolver configuration saved.',
  rules: 'Rules',
  save_success: 'Saved',
  search: 'Search',
