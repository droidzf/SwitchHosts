...
const lang: LanguageDict = {
  ...
  days: 'Tage',
  delete: 'Löschen',
  domain_resolution: 'Domainauflösung',
  ...
  resolver_add: 'Resolver hinzufügen',
  resolver_delete_confirm: 'Resolver „{0}“ löschen?',
  resolver_empty: 'Noch keine Resolver-Konfigurationen.',
  resolver_name: 'Resolver-Name',
  resolver_name_invalid: 'Nur Buchstaben, Zahlen, Punkte, Bindestriche und Unterstriche verwenden.',
  resolver_name_placeholder: 'Zum Beispiel: internal.example',
  resolver_rename: 'Resolver umbenennen',
  resolver_saved: 'Resolver-Konfiguration gespeichert.',
  rules: 'Regeln',
