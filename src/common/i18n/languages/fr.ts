...
const lang: LanguageDict = {
  ...
  days: 'jours',
  delete: 'Supprimer',
  domain_resolution: 'Résolution de domaine',
  ...
  resolver_add: 'Ajouter un Resolver',
  resolver_delete_confirm: 'Supprimer le Resolver « {0} » ?',
  resolver_empty: 'Aucune configuration Resolver.',
  resolver_name: 'Nom du Resolver',
  resolver_name_invalid: 'Utilisez uniquement lettres, chiffres, points, tirets et underscores.',
  resolver_name_placeholder: 'Par exemple : internal.example',
  resolver_rename: 'Renommer le Resolver',
  resolver_saved: 'Configuration Resolver enregistrée.',
  rules: 'Règles',
