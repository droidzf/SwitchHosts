...
const lang: LanguageDict = {
  ...
  reset_zoom: 'ズームをリセット',
  resolver_add: 'Resolver を追加',
  resolver_delete_confirm: 'Resolver「{0}」を削除しますか？',
  resolver_empty: 'Resolver 設定はありません。',
  resolver_name: 'Resolver 名',
  resolver_name_invalid: '英数字、ドット、ハイフン、アンダースコアのみ使用できます。',
  resolver_name_placeholder: '例：internal.example',
  resolver_rename: 'Resolver 名を変更',
  resolver_saved: 'Resolver 設定を保存しました。',
  rules: 'ルール数',
  save_success: '保存しました',
  search: '検索',
  select_all: 'すべて選択',
