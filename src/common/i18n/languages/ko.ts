...
export default {
  ...
  reset_zoom: '확대 재설정',
  resolver_add: 'Resolver 추가',
  resolver_delete_confirm: 'Resolver “{0}”을(를) 삭제하시겠습니까?',
  resolver_empty: 'Resolver 설정이 없습니다.',
  resolver_name: 'Resolver 이름',
  resolver_name_invalid: '영문자, 숫자, 점, 하이픈 및 밑줄만 사용할 수 있습니다.',
  resolver_name_placeholder: '예: internal.example',
  resolver_rename: 'Resolver 이름 변경',
  resolver_saved: 'Resolver 설정을 저장했습니다.',
  rules: '규칙 수',
  save_success: '저장됨',
  search: '찾기',
  select_all: '전체 선택',
